...
with open('data/prompt.json', 'r', encoding='utf-8') as f:
    prompts = json.load(f)
    PROMPT_TEMPLATE_1 = prompts['template1']
    PROMPT_TEMPLATE_2 = prompts['template2']
...
def process_paper(title: str, abstract: str, output_path: str, pmid: str) -> None:
    ...
    analysis_result = generate_analysis(title, abstract, PROMPT_TEMPLATE_1)  # Use template 1
    ...
    if analysis_result["success"]:
        ...
        json_result = generate_json(
            title=title,
            abstract=abstract,
            prompt_template=PROMPT_TEMPLATE_1,  # Use template 1
            analysis_output=analysis_result["response"],
            json_prompt_template=PROMPT_TEMPLATE_2  # Use template 2
        )
...
if __name__ == "__main__":
    ...
    output_path = "data/output_debug.json"
    pmid = "37456789"
